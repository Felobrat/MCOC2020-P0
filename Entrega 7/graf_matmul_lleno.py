...
graf1.set_title('Rendimiento MATMUL Lleno')
...
graf2.plot([8, 16384], [10**2*max(datos[:,4])/16384**2, 16384**2*max(datos[:,4])/16384**2], linestyle='--', color='darkgreen', label="O(N^2)" ) 
graf2.plot([100, 16384], [100**3*max(datos[:,4])/16384**3, 16384**3*max(datos[:,4])/16384**3], linestyle='--', color='orangered', label="O(N^3)" ) 
graf2.plot([400, 16384], [400**4*max(datos[:,4])/16384**4, 16384**4*max(datos[:,4])/16384**4], linestyle='--', color='purple', label="O(N^4)" )
graf2.legend()
plt.tight_layout()
