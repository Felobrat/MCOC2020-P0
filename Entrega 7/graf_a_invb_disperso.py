...
graf1.set_title('Rendimiento Ax=b Disperso')
graf1.plot([16384],[600], "w--")
graf1.plot([2, 16384],[max(datos[:,1]),max(datos[:,1])], linestyle='--', color='royalblue', label="Comstante" )
graf1.plot([2, 16384], [2*max(datos[:,1])/16384, 16384*max(datos[:,1])/16384], linestyle='--', color='gold', label="O(N)" ) 
graf1.plot([2, 16384], [2**2*max(datos[:,1])/16384**2, 16384**2*max(datos[:,1])/16384**2], linestyle='--', color='darkgreen', label="O(N^2)") 
graf1.plot([50, 16384], [50**3*max(datos[:,1])/16384**3, 16384**3*max(datos[:,1])/16384**3], linestyle='--', color='orangered', label="O(N^3)" ) 
graf1.plot([200, 16384], [200**4*max(datos[:,1])/16384**4, 16384**4*max(datos[:,1])/16384**4], linestyle='--', color='purple', label="O(N^4)")
...
graf2.plot([150, 16384], [150**2*max(datos[:,2])/16384**2, 16384**2*max(datos[:,2])/16384**2], linestyle='--', color='darkgreen', label="O(N^2)" ) 
graf2.plot([750, 16384], [750**3*max(datos[:,2])/16384**3, 16384**3*max(datos[:,2])/16384**3], linestyle='--', color='orangered', label="O(N^3)" ) 
graf2.plot([1600, 16384], [1600**4*max(datos[:,2])/16384**4, 16384**4*max(datos[:,2])/16384**4], linestyle='--', color='purple', label="O(N^4)" )
graf2.legend()
plt.tight_layout()
