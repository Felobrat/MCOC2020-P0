...
for i in range(10):
    datos = np.loadtxt(f'Matmul{i}.txt')
    graf1.plot(datos[:,0], datos[:,1],"o-")
...
graf1.set_title('Rendimiento A@B')
...
fig.savefig('DESEMPEÑO MATMUL.png')