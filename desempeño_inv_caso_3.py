...
datos = np.loadtxt('timing_inv_caso_3_np.half.txt')
graf1.plot(datos[:,0], datos[:,1],"o-", label='half')
datos = np.loadtxt('timing_inv_caso_3_np.single.txt')
graf1.plot(datos[:,0], datos[:,1],"o-", label='single')
datos = np.loadtxt('timing_inv_caso_3_np.double.txt')
graf1.plot(datos[:,0], datos[:,1],"o-", label='double')
datos = np.loadtxt('timing_inv_caso_3_np.longdouble.txt')
graf1.plot(datos[:,0], datos[:,1],"o-", label='longdouble')
...
graf1.set_title('Rendimiento INV (CASO 3)')
...
datos = np.loadtxt('timing_inv_caso_3_np.half.txt')
graf2.plot(datos[:,0], datos[:,2],"o-", label='half')
datos = np.loadtxt('timing_inv_caso_3_np.single.txt')
graf2.plot(datos[:,0], datos[:,2],"o-", label='single')
datos = np.loadtxt('timing_inv_caso_3_np.double.txt')
graf2.plot(datos[:,0], datos[:,2],"o-", label='double')
datos = np.loadtxt('timing_inv_caso_3_np.longdouble.txt')
graf2.plot(datos[:,0], datos[:,2],"o-", label='longdouble')
...
fig.savefig('RENDIMIENTO_CASO3.png')