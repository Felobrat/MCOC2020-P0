# -*- coding: utf-8 -*-
"""
Created on Wed Aug 12 19:46:49 2020
...
graf1.plot(datos[:,0], datos[:,1],"o-", label='longdouble_C2')
datos = np.loadtxt('timing_inv_caso_3_np.longdouble.txt')
graf1.plot(datos[:,0], datos[:,1],"o-", label='longdouble_C3')
...
graf1.set_title('Comparacion rendimiento Rendimiento INV (longdouble)')
...
datos = np.loadtxt('timing_inv_caso_2_np.longdouble.txt')
graf2.plot(datos[:,0], datos[:,2],"o-", label='longdouble_C2')
datos = np.loadtxt('timing_inv_caso_3_np.longdouble.txt')
graf2.plot(datos[:,0], datos[:,2],"o-", label='longdouble_C3')
...
fig.savefig('Comparacion RENDIMIENTO_longdouble.png')