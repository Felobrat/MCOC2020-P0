# -*- coding: utf-8 -*-
"""
Created on Wed Aug 12 19:41:03 2020
...
datos = np.loadtxt('timing_inv_caso_1_np.single.txt')
graf1.plot(datos[:,0], datos[:,1],"o-", label='single_C1')
datos = np.loadtxt('timing_inv_caso_2_np.single.txt')
graf1.plot(datos[:,0], datos[:,1],"o-", label='single_C2')
datos = np.loadtxt('timing_inv_caso_3_np.single.txt')
graf1.plot(datos[:,0], datos[:,1],"o-", label='single_C3')
...
graf1.set_title('Comparacion rendimiento Rendimiento INV (single)')
...
datos = np.loadtxt('timing_inv_caso_1_np.single.txt')
graf2.plot(datos[:,0], datos[:,2],"o-", label='single_C1')
datos = np.loadtxt('timing_inv_caso_2_np.single.txt')
graf2.plot(datos[:,0], datos[:,2],"o-", label='single_C2')
datos = np.loadtxt('timing_inv_caso_3_np.single.txt')
graf2.plot(datos[:,0], datos[:,2],"o-", label='single_C3')
...
fig.savefig('Comparacion RENDIMIENTO_single.png')