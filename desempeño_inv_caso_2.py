...
datos = np.loadtxt('timing_inv_caso_2_np.half.txt')
...
datos = np.loadtxt('timing_inv_caso_2_np.longdouble.txt')
...
graf1.set_title('Rendimiento INV (CASO 2)')
...
fig.savefig('RENDIMIENTO_CASO2.png')