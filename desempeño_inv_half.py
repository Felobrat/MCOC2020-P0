# -*- coding: utf-8 -*-
"""
Created on Wed Aug 12 19:34:11 2020
...
graf1.plot(datos[:,0], datos[:,1],"o-", label='half_C2')
datos = np.loadtxt('timing_inv_caso_3_np.half.txt')
graf1.plot(datos[:,0], datos[:,1],"o-", label='half_C3')
...
graf1.set_title('Comparacion rendimiento Rendimiento INV (Half)')
...
datos = np.loadtxt('timing_inv_caso_2_np.half.txt')
graf2.plot(datos[:,0], datos[:,2],"o-", label='half_C2')
datos = np.loadtxt('timing_inv_caso_3_np.half.txt')
graf2.plot(datos[:,0], datos[:,2],"o-", label='half_C3')
...
fig.savefig('Comparacion RENDIMIENTO_half.png')